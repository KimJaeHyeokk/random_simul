$(document).ready(function(){
	...
	function photowidth(){
		...
		} else if(winWidth >= 591 && winWidth < 767) {
			$('.photo_fade').slick('slickSetOption', 'slidesToShow', 2, true);
		} else if(winWidth >= 768 && winWidth < 1020) {
			$('.photo_fade').slick('slickSetOption', 'slidesToShow', 2, true);
		} else if(winWidth >= 1021 && winWidth < 1300) {
			$('.photo_fade').slick('slickSetOption', 'slidesToShow', 2, true);
		} else {
			$('.photo_fade').slick('slickSetOption', 'slidesToShow', 4, true);
		} 
	}
